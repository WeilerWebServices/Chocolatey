...
namespace chocolatey.package.validator.tests.infrastructure.app
{
    ...
    public abstract class BugTrackerUrlShouldBeValidRequirementSpecs : TinySpec
    {
        protected BugTrackerUrlValidRequirement validationCheck;
        protected Mock<IPackage> package = new Mock<IPackage>();

        public override void Context()
        {
            validationCheck = new BugTrackerUrlValidRequirement();
        }
    }

    public class when_inspecting_package_with_empty_bug_tracker_url : BugTrackerUrlShouldBeValidRequirementSpecs
    {
    ...
    public class when_inspecting_package_with_invalid_bug_tracker_url : BugTrackerUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.BugTrackerUrl).Returns(new Uri("http://invalid.url"));
        }
    ...
    public class when_inspecting_package_with_valid_bug_tracker_url : BugTrackerUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.BugTrackerUrl).Returns(new Uri("https://chocolatey.org"));
        }
    ...
    public class when_inspecting_package_with_valid_bug_tracker_url_using_redir : BugTrackerUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
    ...
    /// </summary>
    public class when_inspecting_package_with_mailto_scheme_in_bug_tracker_url : BugTrackerUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.BugTrackerUrl).Returns(new Uri("mailto:someone@yoursite.com"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_bug_tracker_url_that_returns_protocol_error : BugTrackerUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.BugTrackerUrl).Returns(new Uri("https://trac.mpc-hc.org/"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_bug_tracker_url_that_requires_specific_user_agent : BugTrackerUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.BugTrackerUrl).Returns(new Uri("https://www.microsoft.com/en-us/edge"));
        }
