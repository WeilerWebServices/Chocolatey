...
namespace chocolatey.package.validator.tests.infrastructure.app
{
    ...
    /// </summary>
    public class when_inspecting_package_with_mailto_scheme_in_package_source_url : PackageSourceUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.PackageSourceUrl).Returns(new Uri("mailto:someone@yoursite.com"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_package_source_url_that_returns_protocol_error : PackageSourceUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.PackageSourceUrl).Returns(new Uri("https://trac.mpc-hc.org/"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_package_source_url_that_requires_specific_user_agent : PackageSourceUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.PackageSourceUrl).Returns(new Uri("https://www.microsoft.com/en-us/edge"));
        }
