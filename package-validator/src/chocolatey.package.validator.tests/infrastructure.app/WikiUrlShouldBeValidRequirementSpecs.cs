...
namespace chocolatey.package.validator.tests.infrastructure.app
{
    ...
    public abstract class WikiUrlShouldBeValidRequirementSpecs : TinySpec
    {
        protected WikiUrlValidRequirement validationCheck;
        protected Mock<IPackage> package = new Mock<IPackage>();

        public override void Context()
        {
            validationCheck = new WikiUrlValidRequirement();
        }
    }

    public class when_inspecting_package_with_empty_wiki_url : WikiUrlShouldBeValidRequirementSpecs
    {
    ...
    public class when_inspecting_package_with_invalid_wiki_url : WikiUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.WikiUrl).Returns(new Uri("http://invalid.url"));
        }
    ...
    public class when_inspecting_package_with_valid_wiki_url : WikiUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.WikiUrl).Returns(new Uri("https://chocolatey.org"));
        }
    ...
    public class when_inspecting_package_with_valid_wiki_url_using_redir : WikiUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
    ...
    /// </summary>
    public class when_inspecting_package_with_mailto_scheme_in_wiki_url : WikiUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.WikiUrl).Returns(new Uri("mailto:someone@yoursite.com"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_wiki_url_that_returns_protocol_error : WikiUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.WikiUrl).Returns(new Uri("https://trac.mpc-hc.org/"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_wiki_url_that_requires_specific_user_agent : WikiUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.WikiUrl).Returns(new Uri("https://www.microsoft.com/en-us/edge"));
        }
