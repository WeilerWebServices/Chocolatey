...
namespace chocolatey.package.validator.tests.infrastructure.app
{
    ...
    public abstract class ProjectSourceUrlShouldBeValidRequirementSpecs : TinySpec
    {
        protected ProjectSourceUrlValidRequirement validationCheck;
        protected Mock<IPackage> package = new Mock<IPackage>();

        public override void Context()
        {
            validationCheck = new ProjectSourceUrlValidRequirement();
        }
    }

    public class when_inspecting_package_with_empty_project_source_url : ProjectSourceUrlShouldBeValidRequirementSpecs
    {
    ...
    public class when_inspecting_package_with_invalid_project_source_url : ProjectSourceUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.ProjectSourceUrl).Returns(new Uri("http://invalid.url"));
        }
    ...
    public class when_inspecting_package_with_valid_project_source_url : ProjectSourceUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.ProjectSourceUrl).Returns(new Uri("https://chocolatey.org"));
        }
    ...
    public class when_inspecting_package_with_valid_project_source_url_using_redir : ProjectSourceUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
    ...
    /// </summary>
    public class when_inspecting_package_with_mailto_scheme_in_project_source_url : ProjectSourceUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.ProjectSourceUrl).Returns(new Uri("mailto:someone@yoursite.com"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_project_source_url_that_requires_specific_user_agent : ProjectSourceUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.ProjectSourceUrl).Returns(new Uri("https://www.microsoft.com/en-us/edge"));
        }
