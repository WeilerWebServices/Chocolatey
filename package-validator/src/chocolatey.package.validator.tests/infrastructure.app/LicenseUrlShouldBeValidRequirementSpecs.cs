...
namespace chocolatey.package.validator.tests.infrastructure.app
{
    ...
    public abstract class LicenseUrlShouldBeValidRequirementSpecs : TinySpec
    {
        protected LicenseUrlValidRequirement validationCheck;
        protected Mock<IPackage> package = new Mock<IPackage>();

        public override void Context()
        {
            validationCheck = new LicenseUrlValidRequirement();
        }
    }

    public class when_inspecting_package_with_empty_license_url : LicenseUrlShouldBeValidRequirementSpecs
    {
    ...
    public class when_inspecting_package_with_invalid_license_url : LicenseUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.LicenseUrl).Returns(new Uri("http://invalid.url"));
        }
    ...
    public class when_inspecting_package_with_valid_license_url : LicenseUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.LicenseUrl).Returns(new Uri("https://chocolatey.org"));
        }
    ...
    public class when_inspecting_package_with_valid_license_url_using_redir : LicenseUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
    ...
    /// </summary>
    public class when_inspecting_package_with_mailto_scheme_in_license_url : LicenseUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            package.Setup(p => p.LicenseUrl).Returns(new Uri("mailto:someone@yoursite.com"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_license_url_that_returns_protocol_error : LicenseUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.LicenseUrl).Returns(new Uri("https://trac.mpc-hc.org/"));
        }
    ...
    /// </summary>
    public class when_inspecting_package_with_license_url_that_requires_specific_user_agent : LicenseUrlShouldBeValidRequirementSpecs
    {
        private PackageValidationOutput result;
        ...
        public override void Context()
        {
            ...
            // mailto url shouldn't be allowed
            package.Setup(p => p.LicenseUrl).Returns(new Uri("https://www.microsoft.com/en-us/edge"));
        }
