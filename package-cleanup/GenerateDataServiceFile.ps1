...
$serviceFile = "$thisDir\src\chocolatey.package.cleanup\infrastructure.app\webservices\ChocolateySubmittedFeedService.cs"

. $dataSvcUtil /out:"$serviceFile" /version:2.0 /language:csharp /nologo /uri:https://chocolatey.org/api/v2/submitted/
#. $dataSvcUtil /out:"$serviceFile" /version:2.0 /language:csharp /nologo /uri:http://localhost:55881/api/v2/submitted/