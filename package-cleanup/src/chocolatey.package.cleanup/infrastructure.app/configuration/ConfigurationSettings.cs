...
namespace chocolatey.package.cleanup.infrastructure.app.configuration
{
    using System;
    ...
    public class ConfigurationSettings : IConfigurationSettings
    {
        ...
        public int CommandExecutionTimeoutSeconds { get { return int.Parse(get_application_settings_value("CommandExecutionTimeoutSeconds")); } }
