...
{
    public class DatabasePackageStatisticsService : IPackageStatisticsService
    {
        private readonly IEntityRepository<PackageStatistics> _packageStatsRepository;

        public DatabasePackageStatisticsService(IEntityRepository<PackageStatistics> packageStatsRepository)
        {
