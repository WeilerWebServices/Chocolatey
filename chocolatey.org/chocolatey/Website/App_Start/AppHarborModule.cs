...
namespace NuGetGallery
{
    ...
    public class AppHarborModule : IHttpModule
    {
        ...
        public void Init(HttpApplication context)
        {
            ...
            if (string.IsNullOrEmpty(appHarborCommitId)) return;
            ...
            var setReadOnly = Expression.Lambda<Action<NameValueCollection, bool>>(Expression.Call(collectionParam, readOnlyProperty.GetSetMethod(true), valueParam), collectionParam, valueParam).Compile();
            ...
            context.BeginRequest += (sender, args) =>
            {
                ...
                if (!string.IsNullOrEmpty(isAjaxFlag)) serverVariables.Set("X-Requested-With", isAjaxFlag);
