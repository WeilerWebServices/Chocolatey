...
public static class MVC {
    ...
    public static NuGetGallery.RssController Rss = new NuGetGallery.T4MVC_RssController();
...
namespace Links {
    ...
    public static readonly string chocolatey_css = Url("chocolatey.css");
    ...
    public static readonly string AH_Logo_vertical_png = Url("AH_Logo_vertical.png");



    public static readonly string appharbor_logo_png = Url("appharbor-logo.png");
    ...
    public static readonly string github_jpg = Url("github.jpg");
    ...
    public static readonly string RealDimensionsLogo_png = Url("RealDimensionsLogo.png");
    ...
    public static readonly string stackexchange_png = Url("stackexchange.png");
